...
export const ProcessingModal: React.FC<ProcessingModalProps> = ({ progress, total }) => {
  return (
    <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="text-center p-8">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Processando Vídeos...</h2>
        <p className="text-slate-400">Criando {total} variações com os áudios selecionados.</p>
        <div className="mt-4 bg-slate-800 rounded-full h-2 w-64 mx-auto overflow-hidden">
           <div 
